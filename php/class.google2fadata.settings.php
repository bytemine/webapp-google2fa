...
class Google2FAData {
	...
	/**
	 * Set used codes (for example to delete codes)
	 *
	 * @param string $codes used codes
	 */
	public static function setUsedCodes($codes) {
                $GLOBALS["settings"]->set("zarafa/v1/plugins/google2fa/used_codes", Google2FACrypt::encrypt($codes));
                $GLOBALS["settings"]->saveSettings();
        }
